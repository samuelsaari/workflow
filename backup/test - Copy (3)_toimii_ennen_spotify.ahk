...
;^!SHIFT::
!,::roar("ahk_exe chrome.exe", "chrome.exe", "Google Keep")
...
<^!x::roar("Zoom","C:\Users\%A_Username%\AppData\Roaming\Zoom\bin\Zoom.exe") ; %A_Username%
<^!d::roar("ahk_exe teams.exe", "C:\Users\%A_Username%\AppData\Local\Microsoft\Teams\Update.exe --processStart Teams.exe")

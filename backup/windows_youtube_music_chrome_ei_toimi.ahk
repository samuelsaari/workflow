...
;Creating groups with a uniques names;
	...
	GroupAdd, %unique_group2%,ahk_group %unique_group1%, , ,%extitle_str_2%     ;exclude second based on title
...
;---------------------------------------<zxcvbnm,.----------------------------------------
<!SHIFT::roar("ahk_exe chrome.exe", "chrome.exe", EX_TITLE:="Google Keep",EX_AHK:="", TARGET_2:="",ID_2:="",Mode:=1,Parambox:=0,ID_3:="",EX_TITLE_2:="YouTube Music")
...
<!LCTRL::roar("YouTube Music", "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe --app=https://music.youtube.com", , ,TARGET_2:="C:\Program Files\Google\Chrome\Application\chrome.exe --app=https://music.youtube.com",ID_2:="",mode:=2,ParamBox:=0) ;NB!

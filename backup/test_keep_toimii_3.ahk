...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;,
;Firefox 
roa7(IDENTIFIER,TARGET_ONE,EX_TITLE:="",EX_AHK:="ahk_exe nada.exe", TARGET_TWO:="notepad.exe")
{
;;;;;;;;Creating a group;;;;;;;;;
SetTitleMatchMode, 1
;extitle_str:= %EX_TITLE%
GroupAdd, this_group, %IDENTIFIER%, , ,%EX_TITLE%
;GroupAdd, this_group,			    , , %EX_AHK%
...
;!.::roa7("ahk_class MozillaWindowClass","Quick Format Citation,ahk_exe zotero.exe", "ahk_exe chrome.exe")

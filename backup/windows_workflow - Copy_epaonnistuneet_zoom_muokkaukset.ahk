...
; checking if the windows is active
	if WinActive("ahk_group" . unique_group) {
		...
		if (num==1) || (ID_1=="ahk_exe spotify.exe") ||  (ID_1=="ahk_exe zoom.exe")  ; && (num==5) )  ; Zoom and spotify misbehave
			{
...
<!z::roar("Zoom","\AppData\Roaming\Zoom\bin\Zoom.exe" , ID_2:="ahk_exe zoom.exe") ;"ahk_exe ShellExperienceHost.exe") 

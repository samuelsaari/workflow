...
;MsgBox, Creating a group with a unique name;;;;;
SetTitleMatchMode, 1
this_group=%A_DDD%%A_YDay%%A_Hour%%A_Min%%A_MSec%
this_group1=%A_DDD%%A_YDay%%A_Hour%%A_Min%%A_MSec%%1%
MsgBox, %this_group%
GroupAdd, %this_group1%, %ID_1%,,,%extitle_str%
extitle_str:= % EX_TITLE
;GroupAdd, this_groupB, ahk_group this_groupA, , ,%extitle_str%
GroupAdd, this_group,ahk_group this_group1, , , , %EX_AHK%

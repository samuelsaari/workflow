...
; 3 spotify 
; 4 Google keep 
; The rest won't matter (spotify is actually the only truly unrobust one, I just prefer having Stata & Outlook as the 1st and 2nd in the taskbar as the build in function Win + (1 or 2) works quite nicely together with the hotkeys I have assigned for Stata and Outlook.
